...
static const CGFloat kDefaultMaxScale = 3.0;
- (CGFloat)p_maximumZoomScale {
    CGFloat scaleFactor = kDefaultMaxScale;
//    CGSize imageSize = [self p_imageViewSize];
//    if ([self isLandscapeImage:imageView]) { //宽图
//        //如果新的高度放大三倍后都没有达到winHeight的话，就把图片缩放至能达到winHeight高度
//        if (imageSize.height*kZoomScale < _mainScreenHeight+kScrollDefaultSize) {
//            scaleFactor = _mainScreenHeight/imageSize.height;
//        }
//        else {
//            scaleFactor = kZoomScale;
//        }
//    }
//    else { //高图
//        if (imageSize.width*kZoomScale < _mainScreenHeight+kScrollDefaultSize) {
//            scaleFactor = 320/imageSize.width;
//        }
//        else {
//            scaleFactor = kZoomScale;
//        }
